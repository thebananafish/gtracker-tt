...
// Main Site Settings
$site_config['SITENAME'] = '/g/Tracker -beta-';					//Site Name
$site_config['SITEEMAIL'] = 'gtrackerbot@installgentoo.com';		//Emails will be sent from this address
$site_config['SITEURL'] = 'http://tracker.installgentoo.com';	//Main Site URL
...
$site_config['announce_list'] = "http://tracker.installgentoo.com/announce.php, http://tracker.installgentoo.com:6969/announce"; //seperate via comma
...
$site_config['OFFLINEMSG'] = 'HANG ON SITE MIGRATION';	

$site_config['WELCOMEPMON'] = true;			//Auto PM New members
$site_config['WELCOMEPMMSG'] = 'Thank you for registering at our tracker!';

$site_config['SITENOTICEON'] = true;
$site_config['SITENOTICE'] = 'Welcome To /g/Tracker<br /></br><marquee behavior="scroll" direction="left">Come chat with us on #/g/tracker @ irc.p2p-irc.net </marquee>';
...
$site_config["mail_smtp_host"] = ""; // SMTP server hostname
